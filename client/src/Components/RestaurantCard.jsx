...
return (
    <>
        <div className="bg-white p-4 mb-4  w-full rounded-2xl transition duration-700 ease-in-out hover:shadow-lg md:w-1/2 lg:w-1/3">        <div className="w-full h-56 lg:h-64 relative">
          ...
          <img
              src={image.images.length && image.images[0].location}            alt="food"
